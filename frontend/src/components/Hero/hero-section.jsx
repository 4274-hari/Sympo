...
export default function HeroSection() {
  ...
  const onPointerDown = (e) => {
    ...
    chainRef.current.classList.add(styles.dragging)
  ...
  const onPointerMove = (e) => {
    ...
    velocity.current = dx
    angle.current = Math.max(-35, Math.min(35, angle.current + dx * 0.4))

    chainRef.current.style.transform =
      `translateX(-50%) rotate(${angle.current}deg)`
  }

  const onPointerUp = (e) => {
    isDragging.current = false
    chainRef.current.releasePointerCapture(e.pointerId)
    chainRef.current.classList.remove(styles.dragging)
  ...
  return (
    <section id="hero" className="relative min-h-screen overflow-hidden  flex flex-col items-center justify-between px-4 py-8 md:px-8 lg:px-16">
      {/* Hanging College Announcement Board */}
      <div
        className={`
          pointer-events-none
          hidden lg:block
          absolute top-0 right-16 z-20
      ...
      >
        ...
        <div className="flex justify-center">
          <div className="w-[2px] h-24 bg-gradient-to-b from-[#CEA2FD]/80 to-transparent" />
        </div>
        ...
        <div
          className="
            ...
            shadow-[0_20px_60px_rgba(206,162,253,0.35)]
            animate-[swing_6s_ease-in-out_infinite]
          "
        >
          {/* Board Pins */}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="leading-tight text-center">
              <p className="text-sm font-semibold tracking-wide text-[#CEA2FD]">
                VELAMMAL
              </p>
              <p className="text-xs text-[#B6B5D8]">
                ENGINEERING COLLEGE
              </p>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex-1 flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center w-full mt-14">
          {/* Left: Text Content */}
          <div
          ...
          >
            <div className="space-y-3 md:space-y-4">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-3 md:gap-4">
                ...
                <span className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#CEA2FD] font-orbitron">
                  2026
                </span>
      ...
      <div className="relative z-10 w-full flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 mt-8 md:mt-12">
        ...
        <div className="lg:hidden w-full flex justify-center px-4 mt-4">
          <div className="
            ...
            px-4 py-3
            rounded-full
            bg-gradient-to-r from-[#2a103d]/90 to-[#1a0a1f]/90
            backdrop-blur-lg
            border border-red-400/30
